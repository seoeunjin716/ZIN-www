...
3. **OAuth 동의 화면 설정** (처음인 경우)
   - 사용자 유형: 외부 선택
   - 앱 정보 입력:
     - 앱 이름: `seoeunjin Platform` (또는 원하는 이름)
     - 사용자 지원 이메일: 본인 이메일
     - 개발자 연락처 정보: 본인 이메일
   - 범위: 기본값 유지
   - 테스트 사용자: 본인 이메일 추가
...
- **OAuth 설정**: `core.seoeunjin.com/oauthservice/src/main/resources/application.yaml`
...
- **프론트엔드 로그인**: `admin.seoeunjin.com/app/login/page.tsx`
