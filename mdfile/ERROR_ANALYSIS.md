...
```
unable to get image 'seoeunjincom-gateway': error during connect: 
Get "http://%2F%2F.%2Fpipe%2FdockerDesktopLinuxEngine/v1.51/images/seoeunjincom-gateway/json": 
...
`seoeunjincom-gateway` 이미지 이름은 Docker Compose가 자동으로 생성합니다:
- 디렉토리 이름: `seoeunjin.com`
- 점(.) 제거: `seoeunjincom`
- 서비스 이름 추가: `seoeunjincom-gateway`
